...
function Recommend(){
    ...
    return (
        ...
        <div class="recommend-inner">
            <div class="recommmend-header">
                <h2 class="recommend-title">쇼핑추천</h2>
                <span class="recommend-txt">할인이 쎄다! 지금, 특가 상품을 확인하세요.</span>
            </div>
            <div class="recommend-main">
                <div class="recommend-category">
                    <ul class="recommend-list">
                        <li>
                            <button class="recommend-cate-bt recommend-cate-bt-active">쎈딜</button>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="#" class="recommend-cate-bt">소담상회</a>
                        </li>
                    </ul>
                </div>
                            ...
                            <div class="recommend-slide-item">
                              <a href="a.html" class="recommend-link">
                                <div class="recommend-img">
                                  <img src="images/r1.jpg" alt="[오쎈특가 쿠폰최종가 소형 5,070원]  [2024년 달력 얼리버드] 어린왕자, 앤, 곰돌이푸, 애드워드호퍼, 모네, 고흐, 윤동주 등" />
                                </div>
                                <div class="recommend-info">
                                  <ul class="recommend-good-list">
                                    ...
                                    <li>
                                      ...
                                      [오쎈특가 쿠폰최종가 소형 5,070원]  [2024년 달력 얼리버드] 어린왕자, 앤, 곰돌이푸, 애드워드호퍼, 모네, 고흐, 윤동주 등
                                      </p>
                                    </li>
                                  </ul>
                                </div>
            ...
            <div class="recommend-footer">
                    <button className="recommend-footer-bt">쇼핑 홈 바로가기
